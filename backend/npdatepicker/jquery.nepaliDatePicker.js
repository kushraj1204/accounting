...
(function ($) {
    var calendarData = {
        bsMonths: ["Baisakh", "Jestha", "Asar", "Shrawan", "Bhadra", "Ashwin", "Kartik", "Mangshir", "Poush", "Magh", "Falgun", "Chaitra"],
        ...
        var datePickerPlugin = {
            ...
            addEventHandler: function ($element, $nepaliDatePicker) {
                $element.click(function () {
                    ...
                    var dp_h = $nepaliDatePicker.outerHeight();
                    var t = inputFieldPosition.top + $(this).outerHeight(true);
                    var par = $(this).closest('.modal-dialog');
                    if(par.length > 0) {
                        var par_o = par.offset();
                        var tmp = inputFieldPosition.top - par_o.top;
                        if (tmp + dp_h > w_h) {
                            t = inputFieldPosition.top - dp_h;
                        }
                    } else {
                        if (t + dp_h > w_h) {
                            t = inputFieldPosition.top - dp_h;
