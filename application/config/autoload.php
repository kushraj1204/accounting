...
/*
  ...
  |
 */
$autoload['config'] = array('jwt', 'rest');
 ...
 */
$autoload['model'] = array('Module_model', 'Emailconfig_model', 'cms_program_model', 'staffroles_model', 'userlog_model', 'rolepermission_model', 'staff_model');
