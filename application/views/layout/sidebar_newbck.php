        ...
        <ul class="sidebar-menu verttop">
            ...
            if ($this->module_lib->hasActive('student_information')) {
                if (($this->rbac->hasPrivilege('student', 'can_view') ||
                    ...
                    $this->rbac->hasPrivilege('neema_academy', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Student Information'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('neema_academy', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('neemastudent/search'); ?>"><a href="<?php echo base_url(); ?>neemastudent/search"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('neema_academy'); ?></a></li>
                                <?php
                            }
            ...
            if ($this->module_lib->hasActive('examination')) {
                if (($this->rbac->hasPrivilege('exam', 'can_view') ||
                    ...
                    $this->rbac->hasPrivilege('cgpa_grade', 'can_view') ||
                    $this->rbac->hasPrivilege('examination_weightage', 'can_view') ||
                    $this->rbac->hasPrivilege('marksheet', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('Examinations'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('marks_grade', 'can_view') && $grade_setting == 'no') {
                                ?>
                            ...
                            if ($this->rbac->hasPrivilege('marks_grade', 'can_view') && $grade_setting == 'yes') {
                                ?>
                                <li class="<?php echo set_Submenu('cpga_grade/index'); ?>"><a href="<?php echo base_url(); ?>admin/gradecpga"><i class="fa fa-angle-double-right"></i>Grade Settings</a></li> <?php }
                            if ($this->rbac->hasPrivilege('examination_weightage', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('examination_weightage/index'); ?>"><a href="<?php echo base_url(); ?>admin/examweightage"><i class="fa fa-angle-double-right"></i>Examination Weightage</a></li> <?php }
                            if ($this->rbac->hasPrivilege('examination_weightage', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('marksheet/search'); ?>"><a href="<?php echo base_url(); ?>admin/marksheet/search"><i class="fa fa-angle-double-right"></i>Marksheet</a></li> <?php }
                            ?>
            ...
            if ($this->module_lib->hasActive('human_resource')) {
                if (($this->rbac->hasPrivilege('staff', 'can_view') ||
                    ...
                    $this->rbac->hasPrivilege('neema_instructor', 'can_view') ||
                    ...
                    <li class="treeview <?php echo set_Topmenu('HR'); ?>">
                        ...
                        <ul class="treeview-menu">
                            ...
                            if ($this->rbac->hasPrivilege('neema_instructor', 'can_view')) {
                                ?>
                                <li class="<?php echo set_Submenu('neemainstructor/search'); ?>"><a href="<?php echo base_url(); ?>admin/neemainstructor/search"><i class="fa fa-angle-double-right"></i> <?php echo $this->lang->line('neema_instructor'); ?></a></li>
                                <?php
                            }
                            ?>
