...
<script>
    var schoolName = "<?php echo $this->setting_model->getCurrentSchoolName(); ?>";
    var logo = "<?php echo base_url() ?>uploads/school_content/logo/header/<?php echo $this->setting_model->getHeaderImage(); ?>"
</script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>backend/js/fixed-header.js" ></script>
...
?>";
    ...
    $calendar.fullCalendar({
        ...
        timezone: "<?php echo $this->customlib->getTimeZone(); ?>",
        draggable: false,
        ...
        $.ajax({
            ...
            success: function (msg) {
                ...
                if (msg.is_holiday == '1') {
                    ...
                    $('input:radio[name=is_holidays]')[0].checked = true;
                }
                else{
                    $('input:radio[name=is_holidays]')[1].checked = true;
                }
                ...
                $("#eventdates").daterangepicker({
                    ...
                    parentEl: '#viewEventModal'
                });
                $("#event_color_edit").val(msg.event_color);
