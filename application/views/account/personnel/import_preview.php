<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> <?php echo $this->lang->line('account_head_import'); ?> <?php echo $this->lang->line('preview'); ?></h1>
    </section>
                        ...
                        if (!empty($data)):
                            ...
                            <div class="pull-right box-tools">
                                <form method="post" onsubmit="return confirm('Are you sure?');"
                                      action="<?php echo site_url('account/personnel/import_confirm') ?>">
