                ...
                <div class="box box-primary" id="bklist">
                    ...
                    <div class="box-header ptbnull">
                        ...
                        <small class="pull-right">
                            <a href="<?php echo base_url(); ?>account/payment/add_payment"
                               class="btn btn-primary btn-sm">
                                <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_payment'); ?></a>
                        </small>
                    </div><!-- /.box-header -->
                    <div class="box-body">
                        ...
                        <div class="table-responsive mailbox-messages">
                            ...
                            <table id="paymentList" class="table table-bordered ">
                                <thead>
                                <th class="table-primary"><?php echo $this->lang->line('payment_date'); ?></th>
                                <th class="table-primary"><?php echo $this->lang->line('payment_made_to'); ?></th>
                                <th class="table-primary"><?php echo $this->lang->line('payment_no'); ?></th>
                                <th class="table-primary"><?php echo $this->lang->line('descriptions'); ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#paymentList').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': '<?=base_url()?>/account/payment/paymentList',
                "data":
                    function (data) {
