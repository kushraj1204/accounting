...
<div class="content-wrapper" style="min-height: 946px;">
    <section class="content-header">
        <h1>
            <i class="fa fa-user-plus"></i> <?php echo $this->lang->line('account_head_information'); ?></h1>
    </section>
    <!-- Main content -->
                ...
                <div class="box box-info" style="padding:5px;">
                    <div class="box-header with-border">
                        ...
                        <div class="pull-right box-tools">
                            <a class="btn btn-primary btn-sm" href="<?php echo site_url('account/settings/exportformat') ?>">
                    ...
                    <div class="box-body">
                        ...
                        2. <?php echo $this->lang->line('account_import_note_2') ?><br/>
                        3. <?php echo $this->lang->line('account_import_note_3') ?><br/>
                    ...
                    <hr/>
                    <form action="<?php echo site_url('account/settings/import_coa') ?>" id="employeeform" name="employeeform"
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 pt20">
                                    <button type="submit"
                                            class="btn btn-info pull-right"><?php echo $this->lang->line('import_account_heads'); ?></button>
                                </div>
