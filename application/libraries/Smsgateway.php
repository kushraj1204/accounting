...
class Smsgateway
{
    ...
    public function getLoginCredentialContent($credential_for, $sender_details)
    {
        if ($credential_for == "student") {
            ...
            $msg = "Hello " . $student['firstname'] . " " . $student['lastname'] .
                ", your Eshikshya login detail is Username: " . $sender_details['username'] . " Password: " . $sender_details['password'];
        } elseif ($credential_for == "parent") {
            $parent = $this->_CI->student_model->get($sender_details['id']);
            $msg = "Hello " . $parent['guardian_name'] . ", your Eshikshya login detail is Username: " . $sender_details['username'] . " Password: " . $sender_details['password'];
        } elseif ($credential_for == "teacher") {
            $teacher = $this->_CI->teacher_model->get($sender_details['id']);
            $msg = "Hello " . $teacher['name'] . ", your Eshikshya login detail is Username: " . $sender_details['username'] . " Password: " . $sender_details['password'];
        } elseif ($credential_for == "librarian") {
            $librarian = $this->_CI->librarian_model->get($sender_details['id']);
            $msg = "Hello " . $librarian['name'] . ", your Eshikshya login detail is Username: " . $sender_details['username'] . " Password: " . $sender_details['password'];
        } elseif ($credential_for == "accountant") {
            $accountant = $this->_CI->accountant_model->get($sender_details['id']);
            $msg = "Hello " . $accountant['name'] . ", your Eshikshya login detail is Username: " . $sender_details['username'] . " Password: " . $sender_details['password'];
        }
        return $msg;
    }
    ...
    public function getStudentResultContent($student_result_detail)
    {
        ...
        $msg = "Result of '" . $student_result_detail['exam_name'] . "' has been published. Please collect the marksheet for " . $student_name . " from the school.";
        return $msg;
    }
}
