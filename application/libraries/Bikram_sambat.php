...
class Bikram_sambat
{
    ...
    private $englishLeapMonths;
    private $nepaliMonths;

    private $englishYear;
    private $englishMonth;
    private $englishDate;
    ...
    public function getEnglishYear()
    {
        return $this->englishYear;
    }

    public function getEnglishMonth()
    {
    ...
    public function getLastDayOf($year, $month)
    {
        return $this->nepaliMonths[$year - 2000][$month - 1];
    }

    public function toFormattedEnglishString($format = "Y-m-d")
    {
        $date = DateTime::createFromFormat('Y-n-j', $this->englishYear . '-' . $this->englishMonth . '-' . $this->englishDate);
        if ($date) {
