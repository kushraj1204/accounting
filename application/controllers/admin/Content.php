...
class Content extends Admin_Controller {
    ...
    function index() {
        ...
        // } 
        $data['ght'] = $ght;
        $this->form_validation->set_rules('content_title', 'lang:content_title', 'trim|required|xss_clean');
        $this->form_validation->set_rules('content_type', 'lang:content_type', 'trim|required|xss_clean');
        $this->form_validation->set_rules('content_available[]', 'lang:available_for', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($this->datechooser == 'bs') {
                $this->load->view('admin/content/createcontent_bs', $data);
            } else {
            ...
            $data = array(
                ...
                'date_bs' => $this->input->post('upload_date_bs'),
    ...
    function handle_upload() {
        if (isset($_FILES["file"]) && !empty($_FILES['file']['name'])) {
            ...
            $this->form_validation->set_message('handle_upload', $this->lang->line('required'));
            return false;
        }
    }
