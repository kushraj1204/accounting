...
class Itemstock extends Admin_Controller {
    ...
    function index() {
        ...
        $this->form_validation->set_rules('item_id', 'lang:item', 'trim|required|xss_clean');
        $this->form_validation->set_rules('quantity', 'lang:quantity', 'trim|required|xss_clean');
        $this->form_validation->set_rules('item_category_id', 'lang:item_category', 'trim|required|xss_clean');
        ...
        if($this->datechooser == 'bs') {
            $this->load->view('admin/itemstock/itemList_bs', $data);
        } else {
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            if($this->datechooser == 'bs') {
                $this->load->view('admin/itemstock/itemEdit_bs', $data);
            } else {
