...
class Receive extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('from_title', 'lang:from_title', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/receiveview_bs', $data);
            } else {
    ...
    function editreceive($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('layout/header');
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/receiveedit_bs', $data);
            } else {
