...
class Certificate extends Admin_Controller {
    ...
    public function create() {
        ...
        $this->form_validation->set_rules('certificate_name', 'lang:certificate_name', 'trim|required|xss_clean');
        $this->form_validation->set_rules('certificate_text', 'lang:certificate_text', 'required|xss_clean');
        $this->form_validation->set_rules('center_header', 'lang:certificate_title', 'required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($_FILES['background_image']['name'])) {
                ...
                if ($this->upload->do_upload('background_image')) {
                    ...
                    $picture = $this->input->post('old_background_image');
                    $data = array(
                        'id' => $this->input->post('id'),
                        'background_image' => $picture,
                        'certificate_name' => $this->input->post('certificate_name'),
