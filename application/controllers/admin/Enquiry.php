...
class Enquiry extends Admin_Controller {
    ...
    public function index() {
        ...
        if (isset($_POST["search"])) {
            ...
            if ($this->datechooser == 'bs') {
                $fd = $this->input->post('from_date');
                $td = $this->input->post('to_date');
                if ($fd && $td) {
                    $enquiry_date = $fd . '-' . $td;
                }
            }
        ...
        foreach ($enquiry_list as $key => $value) {
            ...
            $enquiry_list[$key]["followupdate_bs"] = $follow_up["date_bs"];
            $enquiry_list[$key]["next_date"] = $follow_up["next_date"];
            $enquiry_list[$key]["next_date_bs"] = $follow_up["next_date_bs"];
        ...
        if($this->datechooser == 'bs') {
            $this->load->view('admin/frontoffice/enquiryview_bs', $data);
        } else {
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('contact', 'lang:phone', 'trim|required|xss_clean');
        $this->form_validation->set_rules('source', 'lang:source', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $fud = $this->input->post('follow_up_date');
            if (!date_empty($fud)) {
                $fud = date('Y-m-d', $this->customlib->datetostrtotime($fud));
            }
            $enquiry = array(
                ...
                'follow_up_date' => $fud,
                'follow_up_date_bs' => $this->input->post('follow_up_date_bs'),
    ...
    public function follow_up($enquiry_id) {
        ...
        $data['enquiry_status'] = $this->enquiry_status;
        if($this->datechooser == 'bs') {
            $this->load->view('admin/frontoffice/follow_up_modal_bs', $data);
        } else {
    ...
    function follow_up_insert() {
        ...
        $this->form_validation->set_rules('response', 'lang:response', 'trim|required|xss_clean');
        $this->form_validation->set_rules('date', 'lang:follow_up_date', 'trim|required|xss_clean');
        $this->form_validation->set_rules('follow_up_date', 'lang:next_follow_up_date', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $follow_up = array(
                ...
                'date_bs' => $this->input->post('date_bs'),
                'next_date_bs' => $this->input->post('follow_up_date_bs'),
    ...
    function follow_up_list($id) {
        ...
        if($this->datechooser == 'bs') {
            $this->load->view('admin/frontoffice/followuplist_bs', $data);
        } else {
    ...
    function details($id) {
        ...
        if($this->datechooser == 'bs') {
            $this->load->view('admin/frontoffice/enquiryeditmodalview_bs', $data);
        } else {
