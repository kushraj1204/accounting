...
class Dispatch extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('to_title', 'lang:to_title', 'required');
        $this->form_validation->set_rules('from', 'lang:from_title', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/dispatchview_bs', $data);
            } else {
    ...
    function editdispatch($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('layout/header');
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/dispatchedit_bs', $data);
            } else {
