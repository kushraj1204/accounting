...
class Complaint extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('name', 'lang:complain_by', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/complaintview_bs', $data);
            } else {
    ...
    function edit($id) {
        ...
        $this->form_validation->set_rules('name', 'lang:complaint_by', 'required');
        $this->form_validation->set_rules('date', 'lang:date', 'required');
        if ($this->form_validation->run() == FALSE) {
            $data['complaint_list'] = $this->complaint_Model->complaint_list();
            ...
            $this->load->view('layout/header');
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/complainteditview_bs', $data);
            } else {
    ...
    public function delete($id) {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-success">'.$this->lang->line('deleted_successfully').'</div>');
