...
class studentidcard extends Admin_Controller {
    ...
    public function create() {
        ...
        $this->form_validation->set_rules('title', 'lang:id_card_title', 'trim|required|xss_clean');
        $this->form_validation->set_rules('validity', 'lang:valid_till', 'trim|required|xss_clean');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if (!empty($_FILES['background_image']['name'])) {
                ...
                if ($this->upload->do_upload('background_image')) {
                    ...
                    $background = $this->input->post('old_background_image');
                }
            } else {
                $background = $this->input->post('old_background_image');
            }
