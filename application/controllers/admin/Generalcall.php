...
class Generalcall extends Admin_Controller {
    ...
    public function index() {
        ...
        $this->form_validation->set_rules('call_type', 'lang:call_type', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/generalcallview_bs', $data);
            } else {
...
//echo $id;  
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('layout/header');
            if($this->datechooser == 'bs') {
                $this->load->view('admin/frontoffice/generalcalleditview_bs', $data);
            } else {
