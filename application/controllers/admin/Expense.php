...
class Expense extends Admin_Controller {
    ...
    function index() {
        ...
        if($this->datechooser == 'bs') {
            $this->form_validation->set_rules('date_bs', 'Date', 'trim|required|xss_clean');
        } else {
        ...
        if($this->datechooser == 'bs') {
            $this->load->view('admin/expense/expenseList_bs', $data);
        } else {
    ...
    function edit($id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            $this->load->view('layout/header', $data);
            if($this->datechooser == 'bs') {
                $this->load->view('admin/expense/expenseEdit_bs', $data);
            } else {
    ...
    function expenseSearch() {
        ...
        $this->load->view('layout/header', $data);
        if($this->datechooser == 'bs') {
            $this->load->view('admin/expense/expenseSearch_bs', $data);
        } else {
