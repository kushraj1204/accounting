...
class Visitorspurpose extends Admin_Controller {
    ...
    function index() {
        ...
        $this->form_validation->set_rules('visitors_purpose', 'lang:purpose', 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success">'.$this->lang->line('purpose_added').'</div>');
    ...
    function edit($visitors_purpose_id) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->session->set_flashdata('msg', '<div class="alert alert-success">'.$this->lang->line('purpose_updated').'</div>');
            redirect('admin/visitorspurpose');
        }
    }
    ...
    function delete($id) {
        ...
        $this->session->set_flashdata('msg', '<div class="alert alert-success">'.$this->lang->line('purpose_deleted').'</div>');
        redirect('admin/visitorspurpose');
    }
