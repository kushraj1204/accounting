...
class Itemsupplier extends Admin_Controller {
    ...
    function create() {
        ...
        $this->form_validation->set_rules('phone', 'lang:phone', 'trim|numeric|xss_clean');
        $this->form_validation->set_rules('email', 'lang:email', 'trim|xss_clean|valid_email');
        $this->form_validation->set_rules('contact_person_phone', 'lang:phone', 'trim|numeric|xss_clean');
        $this->form_validation->set_rules('contact_person_email', 'lang:email', 'trim|xss_clean|valid_email');
