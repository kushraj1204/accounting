...
class Hostelroom extends Admin_Controller {
    ...
    function create() {
        ...
        $hostelroomlist = $this->hostelroom_model->lists();
        $data['hostelroomlist'] = $hostelroomlist;
        $this->form_validation->set_rules('hostel_id', 'lang:hostel', 'trim|required|xss_clean');
        $this->form_validation->set_rules('room_type_id', 'lang:room_type', 'trim|required|xss_clean');
        $this->form_validation->set_rules('room_no', 'lang:room_no', 'trim|required|xss_clean');
        $this->form_validation->set_rules('no_of_bed', 'lang:no_of_bed', 'trim|required|xss_clean');
        $this->form_validation->set_rules('cost_per_bed', 'lang:cost_per_bed', 'trim|required|xss_clean');
        $hostellist = $this->hostel_model->get();
        $data['hostellist'] = $hostellist;
        $roomtypelist = $this->roomtype_model->get();
        $data['roomtypelist'] = $roomtypelist;
