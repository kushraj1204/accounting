...
class Issueitem extends Admin_Controller {
    ...
    public function index() {
        ...
        if($this->datechooser == 'bs') {
            $this->load->view('admin/issueitem/issueitemList_bs', $data);
        } else {
    ...
    public function create() {
        ...
        $this->load->view('layout/header', $data);
        if($this->datechooser == 'bs') {
            $this->load->view('admin/issueitem/issueitemCreate_bs', $data);
        } else {
    ...
    function add() {
        $this->form_validation->set_rules('account_type', 'lang:account_type', 'required|trim|xss_clean');
        $this->form_validation->set_rules('issue_to', 'lang:issue_to', 'required|trim|xss_clean');
        $this->form_validation->set_rules('issue_by', 'lang:issue_by', 'required|trim|xss_clean');
        $this->form_validation->set_rules('issue_date', 'lang:issue_date', 'required|trim|xss_clean');
        $this->form_validation->set_rules('note', 'lang:note', 'required|trim|xss_clean');
        $this->form_validation->set_rules('quantity', 'lang:quantity', 'required|trim|xss_clean');
        $this->form_validation->set_rules('item_category_id', 'lang:item_category', 'required|trim|xss_clean');
        $this->form_validation->set_rules('item_id', 'lang:item', 'required|trim|xss_clean');
        ...
        if ($this->form_validation->run() == false) {
            ...
            $data = array(
                ...
                'issue_date_bs' => $this->input->post('issue_date_bs'),
    ...
    public function returnItem() {
        ...
        $today_bs = $this->customlib->getBSDate($today);
        ...
        $result_final = array('status' => 'pass', 'message' => $this->lang->line('saved_successfully'));
        echo json_encode($result_final);
    }
