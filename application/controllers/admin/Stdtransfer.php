...
class Stdtransfer extends Admin_Controller {
    ...
    public function promote() {
        ...
        $this->form_validation->set_rules('session_id', 'lang:session', 'required|trim|xss_clean');
        $this->form_validation->set_rules('class_promote_id', 'lang:class', 'required|trim|xss_clean');
        $this->form_validation->set_rules('section_promote_id', 'lang:section', 'required|trim|xss_clean');
        if ($this->form_validation->run() == false) {
            $errors = array(
            ...
            if(empty($student_list)) {
                echo json_encode(array('status' => 'fail', 'msg' => 'Please select students'));
            } else {
